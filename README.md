...
> [!NOTE]
> **Licensing note:** moondream2 is Apache 2.0, but Moondream 3 (Preview) and Moondream 3.1 ship under source-available licenses that restrict paid hosted use. See [MOONDREAM_LICENSES.md](MOONDREAM_LICENSES.md) before switching models.
